...
public class ImeiNotFoundActivity extends AppCompatActivity {

    private ImeiNotFoundActivity activity;
    ...
    private AppCompatImageButton downloadNotFoundList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_imei_not_found);
        activity = this;
        appRoomDatabase =
        ...
        imeiList = appRoomDatabase.imeiCacheDao().getImeiListResults(true, false);

        if (imeiList != null){

            resultRV = findViewById(R.id.imei_not_found_rv);
            downloadNotFoundList = findViewById(R.id.download_not_found_list);
            ...
            downloadNotFoundList.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private void createPDF() {
        ...
        try {
            ...
            PdfPCell headerCell = new PdfPCell(new Phrase("এগুলো বিটিআরসি ডাটাবেসে পাওয়া যায় নাই"));
